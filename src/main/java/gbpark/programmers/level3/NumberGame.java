...
public class NumberGame {
	...
	public static void main(String[] args) {
		NumberGame thisClass = new NumberGame();
		CodingTest test = new CodingTest<>(thisClass::solution, INT_ARRAY, INT_ARRAY, INT);
		test.codingTest("[5,1,3,7]	[2,2,6,8]	3");
		test.codingTest("[2,2,2,2]	[1,1,1,1]	0");
		test.codingTest("[2,2,7,8,9]	[1,1,8,9,10]	3");
	}
}
